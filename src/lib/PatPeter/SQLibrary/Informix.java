...
public class Informix extends Database {
    ...
    public Informix(final Logger log,
            final String prefix,
    ...
    protected boolean initialize() {
        try {
            ...
            writeError("Informix driver class missing: " + e.getMessage() + ".", true);
            return false;
        }
    }
    ...
    public boolean open() {
        if (initialize()) {
            final String url = "jdbc:informix-sqli://" + getHostname() + ":" + getPort() + ":informixserver=" + getDatabase() + ";";
            try {
                this.connection = DriverManager.getConnection(url, getUsername(), getPassword());
                this.connected = true;
                return true;
            } catch (final SQLException e) {
                writeError("Could not establish a Informix connection, SQLException: " + e.getMessage(), true);
                return false;
            }
        } else {
            return false;
